...
function torik_css_js_file_call() {
    ...
    wp_enqueue_style( 'bxs_css', get_template_directory_uri().'/css/jquery.bxslider.css', array(), '4.2.12', 'all');
...
wp_enqueue_script('bxs_slider', get_template_directory_uri().'/js/jquery.bxslider.min.js', array(), '4.2.12', 'all');
